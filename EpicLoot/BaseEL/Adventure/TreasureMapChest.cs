...
namespace EpicLoot.BaseEL.Adventure
{
    public class TreasureMapChest : MonoBehaviour
    {
        ...
        public void Setup(Player player, Heightmap.Biome biome, int treasureMapInterval)
        {
            ...
            {
                EpicLootBase.LogError($"Trying to set up TreasureMapChest ({biome} {treasureMapInterval}) but there was no Container component!");
            }
        }
        ...
        public void Reinitialize(Heightmap.Biome biome, int treasureMapInterval, bool hasBeenFound, long ownerPlayerId)
        {
            ...
            if (!hasBeenFound)
            {
                ...
                beacon.m_range = EpicLootBase.GetAndvaranautRange();
            }
        ...
        public static void Postfix(Container __instance)
        {
            ...
            if (zdo != null)
            {
                ...
                if (!string.IsNullOrEmpty(biomeString))
                {
                    ...
                    {
                        EpicLootBase.LogError($"[EpicLoot.Adventure.Container_Awake] Unknown biome: {biomeString}");
                    }
                }
            }
        }
    ...
    public static class Container_RPC_OpenRespons_Patch
    {
        public static void Postfix(Container __instance, long uid, bool granted)
        {
            ...
            if (granted && player != null)
            {
                ...
                {
                    EpicLootBase.Log($"Player is opening treasure map chest ({treasureMapChest.Biome}, {treasureMapChest.Interval})!");
