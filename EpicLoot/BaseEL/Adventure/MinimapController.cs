...
namespace EpicLoot.BaseEL.Adventure
{
    ...
    public class MinimapController : MonoBehaviour
    {
        ...
        public virtual void Awake()
        {
            ...
            if (!_minimap.m_icons.Exists(x => x.m_name == EpicLootBase.TreasureMapPinType))
            {
                _minimap.m_icons.Add(new Minimap.SpriteData { m_name = EpicLootBase.TreasureMapPinType, m_icon = EpicLootBase.Assets.MapIconTreasureMap });
            }
            if (!_minimap.m_icons.Exists(x => x.m_name == EpicLootBase.BountyPinType))
            {
                _minimap.m_icons.Add(new Minimap.SpriteData { m_name = EpicLootBase.BountyPinType, m_icon = EpicLootBase.Assets.MapIconBounty });
            }
        }
        ...
        private void Start()
        {
            ...
            if (_minimap.m_visibleIconTypes.Length < (int)EpicLootBase.TreasureMapPinType + 1)
            {
                _minimap.m_visibleIconTypes = new bool[(int)EpicLootBase.TreasureMapPinType + 1];
            ...
            foreach (var chestInfo in unfoundTreasureChests)
            {
                ...
                if (!TreasureMapPins.ContainsKey(key))
                {
                    var pinInfo = new AreaPinInfo
                    {
                        ...
                        Type = EpicLootBase.TreasureMapPinType,
            ...
            foreach (var bounty in currentBounties)
            {
                ...
                if (!BountyPins.ContainsKey(key))
                {
                    var pinInfo = new AreaPinInfo
                    {
                        ...
                        Type = EpicLootBase.BountyPinType,
