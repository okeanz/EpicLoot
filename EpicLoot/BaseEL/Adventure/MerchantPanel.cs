    ...
    public class MerchantPanel : MonoBehaviour
    {
        ...
        public void BuyItem(Player player, BuyListElement listItem)
        {
            ...
            if (listItem.ItemInfo.IsGamble)
            {
                ...
                Debug.Log($"Purchased {(int)listItem.ItemInfo.Rarity}");
                saveData.PurchasedGambleItem((int)listItem.ItemInfo.Rarity);
            }
            else
            {
            ...
            {
                EpicLootBase.LogWarning($"Could not buy item {listItem.ItemInfo.Item.m_shared.m_name}");
                return;
            }
        ...
        public void Update()
        {
            ...
            foreach (var panel in Panels)
            {
                ...
                {
                    Player.m_localPlayer.GetAdventureSaveData().RefreshPurchasedGambles();
                    panel.RefreshItems(_currencies);
                }
            }
        ...
        public void OnAbandonBounty()
        {
            ...
            if (_audioSource != null)
            {
                _audioSource.PlayOneShot(EpicLootBase.Assets.AbandonBountySFX);
            }
        }
    }
}
