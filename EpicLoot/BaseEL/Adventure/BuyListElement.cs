...
namespace EpicLoot.BaseEL.Adventure
{
    public class BuyListElement : BaseMerchantPanelListElement<SecretStashItemInfo>
    {
        ...
        public void SetItem(SecretStashItemInfo itemInfo, Currencies currencies)
        {
            ...
            if (canAfford)
            {
                MagicBG.color = itemInfo.GuaranteedRarity ? EpicLootBase.GetRarityColorARGB(itemInfo.Rarity) : ItemInfo.Item.GetRarityColor();
            }
            else
            {
            ...
            {
                var color = canAfford ? (itemInfo.GuaranteedRarity ? EpicLootBase.GetRarityColor(itemInfo.Rarity) : "white") : "#808080ff";
                var rarityDisplay = itemInfo.GuaranteedRarity ? EpicLootBase.GetRarityDisplayName(itemInfo.Rarity) : "$mod_epicloot_merchant_unknown";
        ...
        private string GetGambleTooltip()
        {
            ...
            var labels = new[]
            {
                ...
                EpicLootBase.GetRarityDisplayName(ItemRarity.Magic),
            ...
            for (var i = 0; i < 5; ++i)
            {
                var color = i == 0 ? "white" : EpicLootBase.GetRarityColor((ItemRarity) (i - 1));
