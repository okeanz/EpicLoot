...
namespace EpicLoot.BaseEL
{
    ...
    public static class TextsDialog_UpdateTextsList_Patch
    {
        public static void Postfix(TextsDialog __instance)
        {
            ...
            if (EpicLootBase.HasAuga && __instance.transform.parent.name == "Lore")
                return;
        ...
        public static void AddMagicEffectsPage(TextsDialog textsDialog, Player player)
        {
            ...
            foreach (var entry in magicEffects)
            {
                ...
                t.AppendLine($"<size=20><color={EpicLootBase.GetRarityColor(highestRarity)}>{totalEffectText}</color></size>");
            ...
            textsDialog.m_texts.Insert(EpicLootBase.HasAuga ? 0 : 2, 
                new TextsDialog.TextInfo(
                    Localization.instance.Localize($"{EpicLootBase.GetMagicEffectPip(false)} $mod_epicloot_active_magic_effects"), 
        ...
        public static void AddTreasureAndBountiesPage(TextsDialog textsDialog, Player player)
        {
            ...
            textsDialog.m_texts.Insert(EpicLootBase.HasAuga ? 2 : 4, 
                new TextsDialog.TextInfo(
                    Localization.instance.Localize($"{EpicLootBase.GetMagicEffectPip(false)} $mod_epicloot_adventure_title"), 
                    Localization.instance.Localize(t.ToString())));
        }
        ...
        public static void AddMagicEffectsExplainPage(TextsDialog textsDialog)
        {
            ...
            textsDialog.m_texts.Insert(EpicLootBase.HasAuga ? 1 : 3,
                new TextsDialog.TextInfo(
                    Localization.instance.Localize($"{EpicLootBase.GetMagicEffectPip(false)} $mod_epicloot_me_explaintitle"),
                    Localization.instance.Localize(t.ToString())));
        }
    }
