...
namespace EpicLoot.BaseEL
{
    ...
    public class MagicItem
    {
        ...
        public string GetRarityDisplay()
        {
            ...
            return $"<color={color}>{EpicLootBase.GetRarityDisplayName(Rarity)}</color>";
        }
        ...
        public string GetTooltip()
        {
            ...
            for (var index = 0; index < Effects.Count; index++)
            {
                ...
                var pip = EpicLootBase.GetMagicEffectPip(IsEffectAugmented(index));
        ...
        {
            return EpicLootBase.GetRarityColor(Rarity);
        }
        ...
        public void ReplaceEffect(int index, MagicItemEffect newEffect)
        {
            ...
            {
                EpicLootBase.LogError("Tried to replace effect on magic item outside of the range of the effects list!");
                return;
            }
