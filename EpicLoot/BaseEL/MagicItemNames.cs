...
namespace EpicLoot.BaseEL
{
    ...
    public static class MagicItemNames
    {
        ...
        public static string GetNameForItem(ItemDrop.ItemData item, MagicItem magicItem)
        {
            ...
            if (!EpicLootBase.UseGeneratedMagicItemNames.Value || magicItem == null)
            {
                return null;
            }
        ...
        public static string GetAdjectivePartForItem(ItemDrop.ItemData item, MagicItem magicItem)
        {
            ...
            return string.IsNullOrEmpty(adjectivePart) ? EpicLootBase.GetRarityDisplayName(ItemRarity.Epic) : adjectivePart;
        }
