    ...
    public static class EpicLootAuga
    {
        ...
        public static void FixItemBG(GameObject obj)
        {
            ...
            if (magicBG != null)
            {
                ...
                if (image != null)
                {
                    image.sprite = EpicLootBase.GetMagicItemBgSprite();
                }
            }
        ...
        {
            var newButtonPrefab = EpicLootBase.LoadAsset<GameObject>("EnchantingTabAuga");
            var newButton = (GameObject)Object.Instantiate((Object) newButtonPrefab, button.transform.parent);
