...
namespace EpicLoot.BaseEL
{
    ...
    public class WelcomeMessage_FejdStartup_Start_Patch
    {
        ...
        {
            if (EpicLootBase.AlwaysShowWelcomeMessage.Value || !WelcomeMessage.PlayerHasSeenMessage())
            {
                var welcomeMessage = (GameObject)Object.Instantiate((Object) EpicLootBase.Assets.WelcomMessagePrefab, __instance.transform, false);
