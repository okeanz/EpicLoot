...
namespace EpicLoot.BaseEL.Abilities
{
    public class AbilityIcon : MonoBehaviour
    {
        ...
        public virtual void Refresh(Ability ability)
        {
            ...
            {
                Icon.sprite = EpicLootBase.LoadAsset<Sprite>(ability.AbilityDef.IconAsset);
            }

            Binding.enabled = ability.AbilityDef.ActivationMode == AbilityActivationMode.Activated;
            var bindingText = EpicLootBase.AbilityKeyCodes[_index].Value.ToUpperInvariant();
    ...
    public class AbilityBar : ConfigPositionedElement
    {
        ...
        {
            AnchorConfig = EpicLootBase.AbilityBarAnchor;
            PositionConfig = EpicLootBase.AbilityBarPosition;
            base.EnsureCorrectPosition();

            if (_horizontalLayoutGroup.childAlignment == EpicLootBase.AbilityBarLayoutAlignment.Value
                && Mathf.Approximately(_horizontalLayoutGroup.spacing, EpicLootBase.AbilityBarIconSpacing.Value))
            {
                return;
            }

            _horizontalLayoutGroup.childAlignment = EpicLootBase.AbilityBarLayoutAlignment.Value;
            _horizontalLayoutGroup.spacing = EpicLootBase.AbilityBarIconSpacing.Value;
        }
    }
    ...
    public static class Hud_Awake_Patch
    {
        ...
        {
            var abilityBar = (GameObject)Object.Instantiate((Object) EpicLootBase.Assets.AbilityBar, __instance.m_rootObject.transform, false);
