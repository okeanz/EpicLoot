...
namespace EpicLoot.BaseEL.Data
{
    public static class EIDFLegacy
    {
        ...
        public static void CheckForExtendedItemFrameworkLoaded(EpicLootBase instance)
        {
            ExtendedItemFrameworkLoaded =
                false; // instance.gameObject.GetComponent("ExtendedItemDataFramework") != null;
        }
