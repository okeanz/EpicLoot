    ...
    public class AugmentHelper
    {
        ...
        public static AugmentChoiceDialog CreateAugmentChoiceDialog(bool useEnchantingUpgrades)
        {
            ...
            if (EpicLootBase.HasAuga)
            {
                ...
                choiceDialog.MagicBG.sprite = EpicLootBase.GetMagicItemBgSprite();
                ...
                for (var i = 0; i < augmentChoices; i++)
                {
                    ...
                    var focus = (GameObject)Object.Instantiate((Object) EpicLootBase.LoadAsset<GameObject>("ButtonFocusAuga"), button.transform);
            ...
            else
            {
                ...
                for (var i = 0; i < augmentChoices; i++)
                {
                    ...
                    var focus = (GameObject)Object.Instantiate((Object) EpicLootBase.LoadAsset<GameObject>("ButtonFocus"), button.transform);
                    focus.SetActive(false);
                    focus.name = "ButtonFocus";
        ...
        {
            var pip = EpicLootBase.GetMagicEffectPip(magicItem.IsEffectAugmented(i));
        ...
        public static List<KeyValuePair<ItemDrop, int>> GetAugmentCosts(ItemDrop.ItemData item, int recipeEffectIndex)
        {
            ...
            foreach (var itemAmountConfig in augmentCostDef)
            {
                ...
                if (prefab == null)
                {
                    EpicLootBase.LogWarning($"Tried to add unknown item ({itemAmountConfig.Item}) to augment cost for item ({item.m_shared.m_name})");
                    continue;
                }
                ...
                if (itemDrop == null)
                {
                    EpicLootBase.LogWarning($"Tried to add item without ItemDrop ({itemAmountConfig.Item}) to augment cost for item ({item.m_shared.m_name})");
                    continue;
                }
