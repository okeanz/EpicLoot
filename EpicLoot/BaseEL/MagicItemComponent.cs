...
namespace EpicLoot.BaseEL
{
    ...
    public static class ItemDataExtensions
    {
        ...
        public static List<string> GetMundaneSetPieces(ObjectDB objectDB, string setName)
        {
            ...
            foreach (var itemPrefab in objectDB.m_items)
            {
                ...
                if (itemDrop == null)
                {
                    EpicLootBase.LogError($"Item in ObjectDB missing ItemDrop: ({itemPrefab.name})");
                    continue;
                }
        ...
        public static GameObject InitializeCustomData(this ItemDrop.ItemData itemData)
        {
            ...
            if (prefab != null)
            {
                ...
                if ((itemData.IsLegacyMagicItem() || EpicLootBase.CanBeMagicItem(itemDropPrefab.m_itemData)) && !itemData.IsExtended())
                {
                    ...
                    if (EpicLootBase.CanBeMagicItem(itemDropPrefab.m_itemData))
                    {
        ...
        public static string GetSetTooltip(this ItemDrop.ItemData item)
        {
            ...
            {
                EpicLootBase.LogWarning($"[GetSetTooltip] Error on item {item.m_shared?.m_name} - {e.Message}");
            }
    ...
    public static class ItemBackgroundHelper
    {
        public static Image CreateAndGetMagicItemBackgroundImage(GameObject elementGo, GameObject equipped, bool isInventoryGrid)
        {
            ...
            if (equippedImage != null && (!isInventoryGrid || !EpicLootBase.HasAuga))
            {
                equippedImage.sprite = EpicLootBase.GetEquippedSprite();
    ...
    public static class InventoryGrid_UpdateGui_MagicItemComponent_Patch
    {
        ...
        public static void UpdateGuiItems(ItemDrop.ItemData itemData, InventoryGrid.Element element)
        {
            ...
            if (itemData.UseMagicBackground())
            {
                ...
                magicItem.sprite = EpicLootBase.GetMagicItemBgSprite();
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            if (!successPatch2 || !successPatch1)
            {
                ...
                EpicLootBase.LogError($"!successPatch1: {!successPatch1}");
